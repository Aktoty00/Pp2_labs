...
namespace Snake
{
    class Program
    {
        ...
        {
            FileStream v = new FileStream("data1.txt", FileMode.OpenOrCreate, FileAccess.Write);
        ...
        static Snake F2()
        {
            FileStream v = new FileStream("data1.txt", FileMode.OpenOrCreate, FileAccess.Write);
            BinaryFormatter bf = new BinaryFormatter();
            Snake snake1 = bf.Deserialize(v) as Snake;
            v.Close();
            return snake1;
        }
        ...
        {
            FileStream v = new FileStream("data2.txt", FileMode.OpenOrCreate, FileAccess.Write);
            BinaryFormatter bf = new BinaryFormatter();
            bf.Serialize(v, wall);
            v.Close();
        }
        ...
        static Wall F4()
        {
            FileStream v = new FileStream("data2.txt", FileMode.OpenOrCreate, FileAccess.Write);
            BinaryFormatter bf = new BinaryFormatter();
            Wall wall1 = bf.Deserialize(v) as Wall;
            v.Close();
            return wall1;
        }
        ...
        static void F5(int b)
        {
            ...
            StreamWriter a = new StreamWriter(@"C:\Users\Рысдаулет Актоты\Desktop\PP2-labs\labs\lab4\Snake\Snake\record.txt");
            a.WriteLine(b);
            a.Close();
        }
        static int F6()
        {
            ...
            StreamReader a = new StreamReader(@"C:\Users\Рысдаулет Актоты\Desktop\PP2-labs\labs\lab4\Snake\Snake\record.txt");
            string s = a.ReadLine();
            a.Close();
            return int.Parse(s);
        }
        ...
        static void Game()
        {
            while (!gameover)
            {
                ...
                Console.WriteLine("High score : " + record + "          Score: " + score + "          Level:  " + level + "    Speed is:   " + speed);
                ...
                if (snake.CollisionWithWall(wall) || snake.CollisionSnake())
                {
                    ...
                    Console.WriteLine("High score : " + record + " Your score is  " + score);
